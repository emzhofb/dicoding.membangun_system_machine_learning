"""
Script otomatisasi preprocessing data Palmer Penguins.
...
def run_preprocessing(input_path, target_column, output_dir, categorical_columns=None):
  ...
  Args:
      input_path: Path ke dataset mentah (penguins_size.csv)
      target_column: Nama kolom target (species)
      output_dir: Folder output untuk data terpreprocess
      categorical_columns: List kolom kategorikal (island, sex)
  """
  print("=" * 50)
  print("PREPROCESSING PIPELINE - Palmer Penguins")
  print("=" * 50)
